...
import {
  ...
  InfraMetadataRT,
  type InfraMetadataFeature,
} from '../../../common/http_api/metadata';
...
export const initMetadataRoute = (framework: KibanaFramework) => {
  framework.registerRoute(
    ...
    async (requestContext, request, response) => {
      const { nodeId, nodeType, indexPattern, timeRange } = pipe(
      ...
      const info = await getNodeInfo(requestContext, indexPattern, nodeId, nodeType, timeRange);
